...
@Component({
  selector: 'app-credlog',
  templateUrl: './credlog.component.html',
  styleUrls: ['./credlog.component.css']
})
export class CredlogComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialogref: MatDialogRef<CredlogComponent>) { }
